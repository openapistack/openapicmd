...
import { generateClientTypesForDocument } from './client-typegen';
...
describe('generateClientTypesForDocument', () => {
  let imports: string;
  ...
  beforeAll(async () => {
    ...
    const types = await generateClientTypesForDocument(document, {
    ...
    operationTypings = types.operationTypings;
